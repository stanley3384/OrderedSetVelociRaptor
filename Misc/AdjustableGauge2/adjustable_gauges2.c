...
int main(int argc, char **argv)
  {      
    ...
    adjustable_gauge_set_draw_gradient(ADJUSTABLE_GAUGE(gauge1), TRUE);
    ...
    adjustable_gauge_set_draw_gradient(ADJUSTABLE_GAUGE(gauge2), TRUE);
    ...
    adjustable_gauge_set_draw_gradient(ADJUSTABLE_GAUGE(gauge3), TRUE);
    ...
    adjustable_gauge_set_draw_gradient(ADJUSTABLE_GAUGE(gauge4), TRUE);
