...
'''
    Add 1 to columns for labels. The first column in a row is a label. Can test out 384 well
plates also. Need to change the following variables though. For bigger than 384 the row_labels
...
#Open a file and write the HTML.
...
for i in range(0, plates, 1):
    ...
    for j in range(0, columns-1, 1):
        f.write("<th scope=\"col\" bgcolor=\"silver\">%i</th>\n" % (j+1))
