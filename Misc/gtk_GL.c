...
Test code derived from the above reference. Have only been able to get this to work in GTK2 and GTKGLext-1.0. Put a couple of axis lines to rotate around and a pyramid in.
