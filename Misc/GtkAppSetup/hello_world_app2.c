...
/*
    ...
    gcc -Wall hello_world_app2.c -o hello_world_app2 `pkg-config --cflags --libs gtk+-3.0`

    run with: ./hello_world_app2
*/
...
static void app_activate(GtkApplication *app, gpointer data)
  {
    ...
    gtk_window_set_title(GTK_WINDOW(window), "Hello World App2");
...
static void app_startup(GtkApplication *app, gpointer data)
 {
    ...
    g_menu_append(section, "Hello World App2", "app.about");
...
static void about_dialog(GSimpleAction *action, GVariant *parameter, gpointer data)
  {
    ...
    gtk_about_dialog_set_program_name(GTK_ABOUT_DIALOG(dialog), "About Hello World2");
    gtk_about_dialog_set_version(GTK_ABOUT_DIALOG(dialog), "Test Version 1.0");
    gtk_about_dialog_set_comments(GTK_ABOUT_DIALOG(dialog), "Try an application object.");
...
static void install_desktop(GtkWidget *widget, gpointer data)
  {
    /*
      ...
      You need to run the program with sudo ./hello_world_app2 to have permission to
      write to the following locations.
    */
    //gchar *desktop_path=g_strdup("/usr/share/applications/hello-world-app2.desktop");
    //gchar *icon_path=g_strdup("/usr/share/icons/hicolor/256x256/apps/hello_world_app2.png");

    //Install paths for the current user. No sudo required.
    gchar *desktop_path=g_strdup_printf("%s/.local/share/applications/hello-world-app2.desktop", g_get_home_dir());
    gchar *icon_path=g_strdup_printf("%s/.local/share/icons/hicolor/48x48/apps/hello_world_app2.png", g_get_home_dir());
