...
ANOVA, Dunnett's test, Dunn-Sidak, Bonferonni comparisons and contingency tables.
    De Muth, J.E. 2006, Basic Statistics and Pharmaceutical Statistical Applications, Second Edition,
    Chapman & Hall/CRC.
...
Code idea for comparisons with contrasts.
    ...
    Pearson Prentice Hall, pp.282-283 Sleeping Dog example.

Z-factor calculation.
    A Simple Statistical Parameter for Use in Evaluation and Validation of High Throughput 
    Screening Assays, Ji-Hu Zhang, Thomas D. Y. Chung and Kevin R. Oldenburg,
    Journal of Biomolecular Screening, Volumne 4, Number 2, 1999

Chi square calculation for contingency tables.
    Sachs, Lothar, Applied Statistics,
    Springer-Verlag, NY, 1984, P.476-477. 

Levene's test also called Brown Forsythe test and called Levine's in this reference.
     Ott, R. Lyman and Longnecker, Michael. 2001, Statistical Methods and Data Analysis,
     Fifth Edition, Duxbury and Thomson Learning, P.368-371

For figuring out GTK+ and UI development.
     Krause, Andrew. 2007, Foundations of GTK+ Development, Apress.

The printing_layout_set_text_attributes function for printing heatmaps is a truncated version of the following print code. The original code is much more complete and a better example of doing this.
...
Permutation testing and multiplicity adjustments.
     ...
     Ge Y, Dudoit S. and Speed T. P., 2003, Resampling-based multiple testing for microarray data
     analysis. Test (12)1:1-77
