...
/*
   An easy sqlite veiwer for looking at assay plate data and tables generated by the VelociRaptor program.
...
int main(int argc, char *argv[])
  {
    ...
    /*
      Deprecated in GTK3.14. Alternates row colors. I like it but it no longer works.
      set grid lines instead.

      gtk_tree_view_set_rules_hint(GTK_TREE_VIEW(r_tree), TRUE);
    */
    gtk_tree_view_set_grid_lines(GTK_TREE_VIEW(r_tree), GTK_TREE_VIEW_GRID_LINES_BOTH);
